...
echo "Command: ./setup-app-registration.sh \"test-subscription-id\" \"test-app\" \"test-org\" \"test-repo\" \"main\""
echo "Parameters:"
...
echo "Command: ./setup-app-registration.sh \"test-subscription-id\" \"test-app\" \"test-org\" \"test-repo\" \"main\" \"verbose\""
echo "Parameters:"
echo "  SUBSCRIPTION_ID=test-subscription-id"
echo "  APP_NAME=test-app"
echo "  GITHUB_ORG=test-org"
...
echo "Command: ./setup-app-registration.sh \"\" \"test-app\" \"test-org\" \"test-repo\" \"main\""
echo "Parameters:"
